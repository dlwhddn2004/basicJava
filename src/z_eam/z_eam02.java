...
System.out.println(‘A' + 'B') → (131) 문자값 코드가 숫자로 바뀌어서 합해서 계산함
System.out.println('1' + 2) → (51) 
System.out.println('1' + '2') → (99)
System.out.println('J' + “ava”) → (Java) "" 타입은 스프링으로 그어떤 타입을 스프링으로 바꿔저서 해결함
System.out.println(true + null) → (오류)

6 Java의 정석定石 3판 - 연습문제 풀이
[2-6] 다음 중 키워드가 아닌 것은?(모두 고르시오) b,c,d,e (앞글자가 대문자로 하는 키워드는 없다)
a. if
b. True
c. NULL
d. Class
...
a. b = (byte)i; //byte 크기로 따지는게 아니라 값을 표현하는 표현범위로 따짐
b. ch = (char)b; char은 양수만 범위에 포함되는데 byte는 음수 양수가 범위값이라 서로 다르므로 형변환을 할수 없다.
c. short s = (short)ch;
d. float f = (float)l;
e. i = (int)ch;
...
[2-11] 다음중 변수를 잘못 초기화 한 것은? (모두 고르시오) a, c,d,e
a. byte b = 256;
b. char c = '';
c. char answer = 'no';
d. float f = 3.14
