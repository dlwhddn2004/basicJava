...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		...
		//역삼각형 별표 출력해보기
		 ...
		 // 숫자 마추기 게임을 만들어보자.
	/*	 
		 int answer = (int)(Math.random() * 100) + 1; // 1~100 사이의 랜덤수를 발생
		int input =0;
		...
		outer : for(int i=2; i<=9; i++)
		{
			for(int j =1; j<=9; j++)
			{
				if(j ==5)
				{
					...
					// break 는 반복문 자체를 완전히 빠져나갈수 있고 , continue는 완전히 빠져나갈수 없다. 
				}
				System.out.println(i+ " * " + j + " = "+ (i*j));
			}
			System.out.println();
